...
const renderRow = async (item: LessonList) => {
    ...
    return (
        ...
        <td className="flex items-center gap-4 p-4">{item.subject.name}
        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
                ...
                <div className="flex items-center gap-4 self-end">
                    ...
                    {role === "admin" || role === "teacher" && (<button className="w-8 h-8 flex items-center justify-center rounded-full bg-uYellow">
