    ...
    return (<form className="flex flex-col gap-8" onSubmit={onSubmit}>
        ...
        <div className="flex md:flex-row flex-col justify-between">
            ...
            <div className="flex flex-col gap-2 w-full md:w-1/4">
                <label htmlFor="teacher" className="text-xs text-gray-500">{"Teacher"}</label>
                <select multiple {...register("teachers")} className="ring-[1.5px] ring-gray-300 p-2 rounded-md text-sm w-full" defaultValue={data?.teachers} defaultChecked={data?.teachers}>
